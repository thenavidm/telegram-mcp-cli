...
#
#   bash desktop-extension/build.sh    ->  desktop-extension/telegram-<version>.mcpb
set -euo pipefail
...
npx -y @anthropic-ai/mcpb@latest pack "$build" "$root/desktop-extension/telegram-$version.mcpb"

echo
echo "Built desktop-extension/telegram-$version.mcpb"
